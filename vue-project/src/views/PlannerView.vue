...
<template>
    ...
    <div class="body">
        <div class="MyPlanner">
            <h2>My Nutrition Planner</h2>
            <div class="workoutContainer">
                <h4>Explore Dishes</h4>
                <div class="rightSideHolder">
                    <div class="searchContainer">
                        <div class="search">
                            <input type="text" @input="search" class="searchBar" id="search" name="search" placeholder="Search" required>
...
export default {name: 'Planner',
    ...
    methods:
    {
        ...
        search(event)
        {
            ...
            if (searchTerm) {
                this.tempFCards = this.manyFoods.filter(food => 
    ...
    ,mounted()
    {
        axios.get("http://localhost:3000/api/meals", { withCredentials: true })
            .then(response => {
